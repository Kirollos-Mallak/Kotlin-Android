        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/kirollosmallak/kotlinandroid/")
                    ...
                    developers {
                        developer {
                            id.set("kirollosmallak")
                            name.set("kirollosmallak")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/kirollosmallak/kotlinandroid.git")
                        developerConnection.set("scm:git:ssh://github.com/kirollosmallak/kotlinandroid.git")
                        url.set("https://github.com/kirollosmallak/kotlinandroid/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/kirollosmallak/kotlinandroid/issues")
                    }
                }
            }
        }
